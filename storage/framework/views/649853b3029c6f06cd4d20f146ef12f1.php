                    ...
                    <div class="col-lg-4 col-md-6 mb-4">
                        <div class="card team-card h-100 border-0 shadow-sm">
                            ...
                            <div class="card-body text-center p-4">
                                <h5 class="card-title mb-2">Erwin Indra Permana</h5>
                                <span class="badge bg-success mb-3">Developer</span>
                                <p class="text-muted"><i
                                        class="bi bi-envelope-fill me-2"></i>erwinindrapermana23@gmail.com</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 mb-4">
                        <div class="card team-card h-100 border-0 shadow-sm">
                            ...
                            <div class="card-body text-center p-4">
                                ...
                                <span class="badge bg-success mb-3">Designer</span>
                    ...
                    <div class="col-lg-4 col-md-6 mb-4">
                        <div class="card team-card h-100 border-0 shadow-sm">
                            ...
                            <div class="card-body text-center p-4">
                                ...
                                <span class="badge bg-success mb-3">Database Engineer</span>
...
<?php echo $__env->make('layouts.home', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Laravel Project\tanismart-laravel\resources\views/home.blade.php ENDPATH**/ ?>