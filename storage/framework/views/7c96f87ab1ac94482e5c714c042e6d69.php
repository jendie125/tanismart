...
<?php $__env->startSection('content'); ?>
        ...
        <div class="product-card">
            <div class="row">
                <div class="col-md-4">
                    ...
                    <img src="<?php echo e(asset('uploads/' . $produk->gambar)); ?>" id="product-image" class="product-image mt-2"
                        alt="<?php echo e($produk->nama_produk); ?>">
                </div>
                <div class="col-md-8">
                    <h2 class="mt-2 fw-bold"><?php echo e($produk->nama_produk); ?></h2>
                    <p class="text-muted"><?php echo e($produk->deskripsi); ?></p>
                    <h3 class="price-tag" id="harga-produk"></h3>

                    <div class="mt-3">
                        <strong>Variasi:</strong>
                        <?php $__currentLoopData = $produk->produkdetail; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <button class="btn btn-outline-secondary variant-button"
                                onclick="updatePrice('<?php echo e($v['namavariasi']); ?>')">
                                <?php echo e($v['namavariasi']); ?>
    ...
    <script>
        let variasiHarga = <?php echo json_encode($produk->produkdetail, 15, 512) ?>;
        let hargaDefault =
            "Rp <?php echo e(number_format($harga_min, 0, ',', '.')); ?> - Rp <?php echo e(number_format($harga_max, 0, ',', '.')); ?>";
        let selectedVariant = "";
        let selectedPrice = 0;
        const productId = <?php echo e($produk->idproduk); ?>;
            ...
            if (action === 'cart') {
                ...
                setTimeout(() => {
                    window.location.href =
                        `<?php echo e(url('cartsimpan')); ?>?id=${productId}&quantity=${qty}&variant=${encodeURIComponent(selectedVariant)}&price=${selectedPrice}`;
                }, 800);
            } else if (action === 'buy') {
                window.location.href =
                    `<?php echo e(url('checkout')); ?>?id=${productId}&quantity=${qty}&variant=${encodeURIComponent(selectedVariant)}&price=${selectedPrice}`;
            }
        }
...
<?php echo $__env->make('layouts.home', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Laravel Project\tanismart-laravel\resources\views/produkdetail.blade.php ENDPATH**/ ?>